...
\end{cvitems}
\textbf{Otros proyectos}.\\
Asistente de investigación.
\begin{cvitems}
    \item Diseño e implementación de modelos ERGM y QAP sobre redes de empresas.
    \item Confección de base de datos financieros de multilatinas para un proyecto del BID.
    \item Redacción de capítulos de libro sobre la historia del sector espacial argentino.
\end{cvitems}
...
\textbf{Técnicas}
\begin{cvitems}
  \item R, Python. Familiar con SQL, Stata, Tableau Public.
\end{cvitems}
\textbf{Idiomas}
\begin{cvitems}
